        ...
        <AppBar position="static">
          <Toolbar>
            <IconButton
              ...
              sx={{ mr: 2 }}
            >
              <Link to={"/"}><img src="https://www.favicon.cc/logo3d/985778.png" alt="" style={{ width: "30px" }} /></Link>
            </IconButton>
            <Typography variant="h6" component="div" sx={{ flexGrow: 1 }}>
              <Link to={"/"} style={{textDecoration:"none",color:"white"}}>RBUILDER</Link>
            </Typography>
            <Tooltip title={content}><Button style={{color:"white"}}>ABOUT US</Button></Tooltip>
          </Toolbar>
        </AppBar>
      </Box>
